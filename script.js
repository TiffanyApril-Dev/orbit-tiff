...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // initTelescopeFollower();   // Telescope cursor disabled
  // initCursorToggle();        // Cursor decoration toggle button disabled
  ...
  initGalleryModal();        // Works page - logo gallery popup
...
function initGalleryModal() {
  ...
  document.querySelectorAll('.gallery-popup-trigger').forEach(btn => {
    btn.addEventListener('click', () => {
      const src = btn.dataset.gallery;
